<template>
    <section>
              <br><b-button tag="router-link"
                to="/homePage"
                type="is-link" size = "is-large" id = "homebutton">
                <strong>< Home</strong> 
            </b-button>
            <p id = "title">Transaction Details</p><br><br>
      <div class = "columns">
      <div class = "column">
        <b-message title="Transaction Type" type = "is-info" size = "is-medium" aria-close-label="Close message">
        <p v-if = 'transaction.eTransferTo !== ""'>This transaction was an {{transaction.transactionType}} to {{transaction.eTransferTo}}. </p><p v-else>This transaction was a {{transaction.transactionType}}.</p>
           </b-message>
