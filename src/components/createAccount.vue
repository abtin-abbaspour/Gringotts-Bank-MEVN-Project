<template>
  <section>
    ...
    <b-field label="Password">
      <b-input v-model="account.password" type="password" minlength = "5" maxlength = "15" placeholder = "Password" icon = "key" password-reveal></b-input>
    </b-field>
    <b-field label="Confirm Password">
      <b-input v-model = "confirmPassword" type="password" minlength = "5" maxlength = "15" placeholder = "Confirm Password" icon = "key" password-reveal></b-input>
    </b-field>
  </section>
</template>
<template>
