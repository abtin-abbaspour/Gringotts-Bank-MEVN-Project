<!--The top is a carousel item with general info about the banking app, changes every 
  2.2 seconds except when your cursor is placed on a slide, tile elements below explaining information-->
        ...
        <div class="tile">
          <div class="tile is-parent is-vertical">
            <article class="tile is-child notification is-second">
              <p class="title">Your Money is Always Safe</p>
              <p class="subtitle"><br>Rated Toronto's #1 Banking Group 3 years in a row by a panel of top critics and judges.</p>
            </article>
            <article class="tile is-child notification is-second">
          ...
          <div class="tile is-parent">
            <article class="tile is-child notification is-second">
              <p class="title">Gringotts Banking</p>
              <p class="subtitle">"Investing in the Future"</p>
      ...
      <div class="tile is-parent">
        <article class="tile is-child notification is-second">
          <div class="content">
            ...
            <p class="subtitle"><br>Gringotts banking is a leading Torontonian and North American financial institution. From personal, business and commerical banking, all the way to wealth managment and capital market investments. Our employees, finanical advisors and data scientists provide a diverse range of skills, financial products and services to more than a million clients across Toronto. </p>
    ...
    export default {
        data() {
            return {
                ...
                { text: 'Press "Actions" to make a new transaction.', color: 'first' },
                { text: 'Click on a transaction to view its details.', color: 'second' },
                { text: 'Banking has never been easier!', color: 'first' }
            ]
          }
        }
    }
